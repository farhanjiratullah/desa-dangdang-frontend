<template>
    ...
    <section id="team" class="testimonials section light-background">
        <div class="container">
            ...
            <div class="row gy-4">
                <div v-for="item in teams" class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
                    <div class="testimonial-item p-5">
                        ...
                        <p class="font-thin text-center text-lg not-italic">{{item.tagline}}</p>
                    </div>
                </div>
            </div>
