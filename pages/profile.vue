<template>
    ...
    <!-- Profile Section -->
    <section id="profile" class="berita section">
        <!-- Section Title -->
        ...
        <div class="container prose" data-aos="fade-up">
            <article v-html="profile.content" class="profile-content"></article>
        </div>
    </section>
    <!-- /Profile Section -->
</template>
...
<style>
    ...
    /* Right-aligned image */
    .profile-content figure.image-style-side {
        text-align: right;
        margin-left: auto;
        margin-right: 0;
    }

    .profile-content figure.image-style-side img {
        display: block;
        float: right;
        margin-left: auto;
        margin-right: 0;
