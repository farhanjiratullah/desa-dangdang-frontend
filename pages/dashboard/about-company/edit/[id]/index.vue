...
const getAboutCompanyByID = async() => {
    ...
    try {
        const dataAboutCompany = await fetchDataByID("/about-companies/admin", id)
        form.value.description = dataAboutCompany.data.description
    } catch (error) {
...
const handlerSubmit = async() => {
    ...
    try {
        ...
        await editData('/about-companies/admin', requestData, id)
