<template>
    ...
    <div class="flex flex-row items-center justify-between">
        ...
        <NuxtLink
            to="/dashboard/portofolio/testimoni/create"
    ...
    <div class="relative w-full overflow-x-auto shadow-md sm:rounded-lg">
        ...
        >
            ...
            >
                <tr>
                    ...
                    <th scope="col" class="px-6 py-3">Kampung</th>
            ...
            <tbody>
                ...
                >
                    ...
                    <td class="px-6 py-4">
                        <img :src="item.thumbnail" class="w-20" alt="" />
                    </td>
                    <th
                        scope="row"
                        class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white"
                    ...
                    <td class="flex items-center px-6 py-4">
                        <NuxtLink
                            :to="`/dashboard/portofolio/testimoni/edit/${item.id}`"
        ...
        >
            ...
            >
                <div
                    class="relative bg-amber-200 rounded-lg shadow dark:bg-gray-700"
                >
                    <button
