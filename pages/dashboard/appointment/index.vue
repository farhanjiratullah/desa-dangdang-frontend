            ...
            <tbody>
                ...
                >
                    ...
                    <td class="flex items-center px-6 py-4">
                        <NuxtLink
                            :to="`/dashboard/appointment/detail/${item.id}`"
                            class="font-medium mr-2 text-amber-600 dark:text-blue-500 hover:underline"
                            >Detail</NuxtLink
                        >
                        <button
...
<script setup>
    ...
    const deleteAboutCompany = async () => {
        ...
        if (id) {
            try {
                await deleteData("/appointments/admin", id);
    ...
    const loadData = async () => {
        ...
        loading.value = true;
        try {
            data.value = await fetchData("/appointments/admin");
        } catch (error) {
